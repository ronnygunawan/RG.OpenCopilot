...
public class ContainerExecutorServiceTests {
    ...
    public async Task ExecutePlanAsync_WithContainerCreationFailure_ThrowsException() {
        ...
        exception.Message.ShouldBe("Container creation failed");
    }
    ...
    public async Task ExecutePlanAsync_WithMissingToken_ContinuesWithWarning() {
        ...
        // Assert - should complete despite missing token
        containerManager.ContainerCreated.ShouldBeTrue();
    }
    ...
    public async Task ExecutePlanAsync_CleansUpContainerOnException() {
        ...
        // Assert - container should be cleaned up even on failure
        containerManager.ContainerCleaned.ShouldBeTrue();
    }
    ...
    private class TestContainerManagerThatFailsCreation : IContainerManager {
        public Task<string> CreateContainerAsync(string owner, string repo, string token, string branch, CancellationToken cancellationToken = default) {
